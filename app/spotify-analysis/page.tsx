    ...
    <main className="min-h-screen">
      ...
      <section className="py-16 px-4 border-b border-gray-200">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-700 mb-4">An end-to-end analytics platform that:</p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <div className="space-y-8">
              <div>
                <h4 className="text-base font-semibold text-secondary mb-3">Filter Panel (left sidebar)</h4>
              ...
              <div>
                <h4 className="text-base font-semibold text-secondary mb-3">Spotibot — Conversational AI Agent</h4>
                <p className="text-gray-700 mb-4">
              ...
              <div>
                <h4 className="text-base font-semibold text-secondary mb-3">Metrics & Stream History</h4>
                <p className="text-gray-700 mb-4">
              ...
              <div>
                <h4 className="text-base font-semibold text-secondary mb-3">Listening Charts</h4>
                <p className="text-gray-700 mb-4">
              ...
              <div>
                <h4 className="text-base font-semibold text-secondary mb-3">Artist Detail Drawer</h4>
                <p className="text-gray-700 mb-4">
              ...
              <div>
                <h4 className="text-base font-semibold text-secondary mb-3">AI Recommendations Modal</h4>
                <p className="text-gray-700 mb-4">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            <h3 className="text-xl font-bold mb-6 text-primary">Data Pipeline (Pipeline Builder)</h3>
            <p className="text-gray-700 mb-6">A no-code pipeline that handles:</p>
            <div className="space-y-6">
              <div>
                <h4 className="text-base font-semibold text-secondary mb-2">1. Parse & Clean</h4>
              ...
              <div>
                <h4 className="text-base font-semibold text-secondary mb-2">2. Enrich</h4>
                <p className="text-gray-700">
              ...
              <div>
                <h4 className="text-base font-semibold text-secondary mb-2">3. LLM Genre Classification</h4>
                <p className="text-gray-700">
